...
- [[tls-handshake|TLS handshake]] — el `ChangeCipherSpec` y el `Finish` del handshake regular, sobre los que esta nota generaliza a "en cualquier momento"
- [[sesion-y-conexion-tls|Sesión y conexión TLS]] — qué parámetros concretos quedan reemplazados cuando una renegociación efectivamente ocurre
- [[tls-arquitectura-y-record|TLS: arquitectura y record]] — el TLS Record que transporta tanto el Change Cipher Spec como los mensajes de Alert
- [[x509|X.509]] — la verificación de certificado cuyas fallas disparan buena parte de las advertencias de Alert
- [[revocacion-y-listas-crl|Revocación y listas CRL]] — la fuente del error "certificado revocado"
- [[infraestructura-de-clave-publica|Infraestructura de clave pública]] — la dependencia que el panorama final señala como total
- [[clase-05-protocolos-criptograficos#14. Change Cipher Spec, Alert y panorama final|Clase 05 — Protocolos criptográficos]] — sección 14, de donde sale esta nota
