...
>
> **Lo que cerró la ingesta del 03/09**: la segunda mitad sin transcripción; la lectura de Katz; el ataque de sufijo al `CBC-MAC`, que la cátedra resolvió en el Anexo de la Práctica 04; la filmina 23; y la sospecha de *rainbow tables*, con cero apariciones. Nota de archivo: hasta el 04/09 la segunda grabación se llamaba `Clase 04 - Transcripcion.VTT` y **no era la Clase 4** — `raw/` se numera por **sesión**, no por tema. El archivo que hoy lleva ese nombre, llegado el 13/09, **sí es la Clase 4**: se verificó leyendo sus primeras frases, y está ingerido en [[clase-04-criptografia-asimetrica-y-firma-digital|Clase 04]]. Los [[video-04-integridad-de-la-informacion-1|videos 04]] y [[video-05-integridad-de-la-informacion-2|05]] de Ramele cubren el mismo temario con otro docente.
