---
title: Guía 1 — Resolución
resumen: 'Las cuentas resueltas y verificadas de la Guía 1 de criptografía clásica: el desplazamiento del Ej. 3, el Vigenère del Ej. 4, la clasificación de criptogramas, el Kasiski corrido y el conteo de fuerza bruta.'
fuentes: ["[[guia-01-criptografia-clasica]]", "[[clase-01-introduccion-y-criptografia-clasica]]", "[[practica-01-esquemas-y-taxonomias]]"]
aliases: [Resolución Guía 1, Guia 1 resolucion, Soluciones Guía 1]
type: resolucion
clase: 1
orden: 22
guia: 1
...
sources: ["raw/guias/guia1/Resolucion Guia 1.md", "raw/guias/guia1/G1-Ej3.py", "raw/guias/guia1/G1-Ej6-kasiski.py", "raw/guias/guia1/Guia 1 - Criptografía Clásica - Soluciones.pdf"]
---

# Guía 1 — Resolución

> [[guia-01-criptografia-clasica|Enunciados]] · [Apuntes crudos](../../raw/guias/guia1/Resolucion%20Guia%201.md) · [Soluciones de la cátedra](../../raw/guias/guia1/Guia%201%20-%20Criptograf%C3%ADa%20Cl%C3%A1sica%20-%20Soluciones.pdf) · Teoría: [[clase-01-introduccion-y-criptografia-clasica|Clase 01]] · Práctica del mismo día: [[practica-01-esquemas-y-taxonomias|Práctica 01 — Esquemas y taxonomías]]

Esta nota reúne **las cuentas hechas de la Guía 1**: el desplazamiento del Ej. 3 reconstruido símbolo por símbolo, el Vigenère del Ej. 4 con la aritmética modular a la vista, el criterio que clasifica los tres criptogramas del Ej. 5, el Kasiski del Ej. 6 corrido de verdad y el conteo de fuerza bruta del Ej. 7 bien contado. Los enunciados literales viven en la [[guia-01-criptografia-clasica|nota hermana]]; acá arriba de cada ejercicio va sólo el resumen en cursiva.
...
> **Estado al 24/08:** Ej. 1, 3, 4, 5 y 7 **resueltos y verificados** · Ej. 2 y 6 **en curso** — el 2 tiene escrito el argumento de grupo y le falta el ejemplo concreto que pide la consigna; el 6 tiene la herramienta corrida, la longitud de clave comprobada y la clave obtenida, pero **sin volcar al crudo** · Ej. 8 **pendiente** (no hay nada en el crudo). Ver el [[guia-01-criptografia-clasica#Tablero de estado|tablero]].

> **Nota de método.** Este apunte **verifica** todo lo que el [crudo](../../raw/guias/guia1/Resolucion%20Guia%201.md) anotó de forma telegráfica, en vez de copiarlo. Donde la cuenta del crudo no da, la discrepancia queda marcada en un recuadro **Discrepancia con el crudo** y se escribe el resultado verificado. El [PDF de soluciones de la cátedra](../../raw/guias/guia1/Guia%201%20-%20Criptograf%C3%ADa%20Cl%C3%A1sica%20-%20Soluciones.pdf) —que llegó al vault el 24/08— se usa como tercer control.
...
- [[guia-01-criptografia-clasica|Guía 1 — Criptografía Clásica]] — los ocho enunciados y el tablero de estado
- [[clase-01-introduccion-y-criptografia-clasica|Clase 01 — Introducción y criptografía clásica]] — la teoría del 06/08
- [[practica-01-esquemas-y-taxonomias|Práctica 01 — Esquemas y taxonomías]] — el árbol que le cuelga a cada cifrado la vía por la que se lo ataca
- [[cifrado-por-rotacion|Cifrado por rotación]] · [[cifrado-de-sustitucion-monoalfabetica|Sustitución monoalfabética]] · [[cifrado-de-vigenere|Vigenère]] · [[cifrado-por-transposicion|Transposición]]
- [[criptoanalisis-por-frecuencias|Criptoanálisis por frecuencias]] · [[test-de-kasiski|Test de Kasiski]] · [[indice-de-coincidencia|Índice de coincidencia]] · [[ataque-de-fuerza-bruta|Fuerza bruta]]
- [[guia-02-resolucion|Guía 2 — Resolución]] — retoma Vigenère y rotación desde el [[secreto-perfecto|secreto perfecto]]
