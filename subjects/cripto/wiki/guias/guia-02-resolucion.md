---
title: Guía 2 — Resolución
resumen: 'Los ocho ejercicios de la Guía 2 resueltos de punta a punta, con el razonamiento y no solo el resultado: secreto perfecto y sus refutaciones, el juego Eav, modos de encadenamiento y las claves débiles de DES.'
fuentes: ["[[guia-02-criptografia-simetrica]]", "[[clase-02-cifrado]]"]
aliases: [Resolución Guía 2, Guia 2 resolucion, Soluciones Guía 2]
type: resolucion
clase: 2
orden: 22
guia: 2
created: 2026-08-24
updated: 2026-09-04
tags: [guia, resolucion, criptografia-simetrica, secreto-perfecto, indistinguibilidad, modos-de-encadenamiento, des, vigenere]
...
> [[guia-02-criptografia-simetrica|Enunciados]] · [PDF de la cátedra](../../raw/guias/guia2/Guia%202%20-%20Criptograf%C3%ADa%20Sim%C3%A9trica.pdf) · [Apuntes crudos](../../raw/guias/guia2/Resolucion%20Guia%202.md) · Teoría que la cubre: [[clase-02-cifrado|Clase 02 — Cifrado simétrico]]
...
Los enunciados literales viven en la [[guia-02-criptografia-simetrica|nota hermana]]; acá arriba de cada ejercicio va sólo el resumen en cursiva.
...
- [[guia-02-criptografia-simetrica|Guía 2 — Criptografía Simétrica]] — los ocho enunciados transcriptos, con el tablero de estado
- [[guia-01-resolucion|Guía 1 — Resolución]] — la guía anterior, sobre criptografía clásica
- [[probabilidad-y-criptografia|Probabilidad y criptografía]] — el **Ejemplo 2** es literalmente el sistema del Ejercicio 1, con las cuentas ya desarrolladas
- [[secreto-perfecto|Secreto perfecto]] — la definición, las caracterizaciones equivalentes y el teorema de Shannon (Ejercicios 1, 2, 3, 4)
- [[one-time-pad|One Time Pad]] — el contraejemplo del Ejercicio 2 y la plantilla de los tres incisos del Ejercicio 3
- [[pruebas-de-indistinguibilidad|Pruebas de indistinguibilidad]] — el juego `Eav` del Ejercicio 1d y el 4b, y el teorema *determinístico ⟹ no CPA-Secure* del Ejercicio 5
- [[modelos-de-ataque|Modelos de ataque]] — el modelo CPA del Ejercicio 5
- [[modos-de-encadenamiento|Modos de encadenamiento]] — `CBC` y `CFB` de los Ejercicios 6 y 7
- [[primitiva-de-cifrado-en-bloque|Primitiva de cifrado en bloque]] — tamaño de bloque y corrección del Ejercicio 7a
- [[aritmetica-modular-y-divisibilidad|Aritmética modular y divisibilidad]] — divisibilidad, mcd y congruencia módulo $m$: la base sobre la que se apoya todo el Ejercicio 7
- [[algoritmo-de-euclides-extendido#6. Ejemplo 1: el mcd de 7 y 32|Algoritmo de Euclides extendido]] — su Ejemplo 1 **es** el $\operatorname{mcd}(7,32)$ del Ejercicio 7c, corrido con las dos formas
- [[inverso-modular|Inverso modular]] — por qué sólo las $K$ impares sirven (Ej. 7a) y de dónde sale $7^{-1} = 23$ (Ej. 7c), con la tabla de los 16 inversos módulo 32
- [[teoria-de-numeros|Teoría de números]] — el manuscrito de la cátedra que encarga el tema al cerrar la Clase 02; no trae ningún ejemplo numérico y manda a este Ejercicio 7
- [[des-y-3des|DES y 3-DES]] — Feistel y el key schedule del Ejercicio 8
- [[clase-02-cifrado|Clase 02 — Cifrado simétrico]] — la teoría que cubre toda la guía
