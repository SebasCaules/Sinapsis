---
title: "1er Parcial — Material de Estudio Organizado"
resumen: "Índice del material del primer parcial: enlaces a las sesiones de estudio por unidad con sus calificaciones, los errores críticos para repasar y la estrategia de estudio antes del examen."
type: indice
unidad: parciales
fecha_creacion: 2026-04-14
---

# 1er Parcial — Material de Estudio
...
- **sesion-estudio-unidad-1** (sesión de práctica personal, no se publica) — 10 preguntas + correcciones (Unidad 1: Introducción al Derecho)
- **sesion-estudio-unidad-2** (sesión de práctica personal, no se publica) — 10 preguntas + correcciones (Unidad 2: Organización del Estado)
- **sesion-estudio-unidad-3** (sesión de práctica personal, no se publica) — 10 preguntas + correcciones (Unidad 3: Derecho Civil)
- **sesion-estudio-unidad-4** (sesión de práctica personal, no se publica) — 10 preguntas + correcciones (Unidad 4: Derecho Comercial)
- **sesion-estudio-unidad-5** (sesión de práctica personal, no se publica) — 10 preguntas + correcciones (Unidad 5: Propiedad Intelectual)

### Preguntas Integradores (20 preguntas)
- **sesion-estudio-preguntas-mixtas** (sesión de práctica personal, no se publica) — 20 preguntas combinadas de todas las unidades con correcciones detalladas
...
## 🚨 Errores Críticos (Estudiar URGENTE)

1. **Art. 75 inc. 22 CN** — Jerarquía constitucional de tratados de DD.HH. (PREGUNTA SEGURA)
2. **Orden de fuentes del derecho** — Ley > Costumbre (NO invertido)
3. **Jerarquía tratados** — Tratados DD.HH. = CN (desde 1994)
4. **Duraciones PI** — Patentes 20 años (NO 15); Derecho de autor vida + 70 años
5. **Ley 11.867** — Transferencia de fondo de comercio (MEMORIZAR número)
