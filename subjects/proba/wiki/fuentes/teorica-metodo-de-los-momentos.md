...
resumen: 'Teórica manuscrita de la unidad 8 con el método de los momentos: escribir el momento poblacional como función del parámetro, igualarlo al momento muestral y despejar; en el ejemplo exponencial resulta $\hat\lambda=1/\overline X_n$.'
tipo: fuente
formato: pdf
unidad: 8
