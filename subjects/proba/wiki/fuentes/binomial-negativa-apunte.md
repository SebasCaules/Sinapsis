...
resumen: 'Apunte manuscrito de la unidad 3 sobre la binomial negativa o de Pascal, en la versión número de fracasos hasta el $r$-ésimo éxito: $p_X(k)=\binom{k+r-1}{k}q^kp^r$, con $E[X]=rq/p$ y $V(X)=rq/p^2$.'
tipo: fuente
formato: apunte
unidad: 3
