...
resumen: 'Apunte manuscrito de la unidad 3 sobre la distribución de Poisson: $p_X(k)=\lambda^ke^{-\lambda}/k!$ con $E[X]=V(X)=\lambda$, su origen en el proceso de Poisson y como límite de la binomial, con el ejemplo de pasajeros que llegan a una parada.'
tipo: fuente
formato: apunte
unidad: 3
