...
resumen: "Hub de la unidad 2, el modelo matemático de la incertidumbre: espacio muestral y eventos, leyes de De Morgan, axiomas de Kolmogorov, regla de Laplace, condicional, independencia, Bayes y árbol de probabilidades."
tipo: concepto
unidad: 2
orden: 1
hub: true
...
Aquí se arma todo el aparato (espacio muestral, axiomas, condicional, independencia,
...
## Hacia adelante
La probabilidad sobre eventos es la base para las [[variable-aleatoria|variables aleatorias]] (unidades 3–5): una v.a. asigna números a los resultados y traslada
$P$ a distribuciones.
